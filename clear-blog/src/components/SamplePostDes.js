...
import Astronaut from '../img/post-sample-image.jpg'

class SamplePostDes extends Component {
    render(){
        return(
                ...
                <div className="row">
                    <div className="col-lg-8 col-md-10">
                        <p>Never in all their history have men been able truly to conceive of the world as one: a single 
                            ...
                            equal earth which all men occupy as equals. The airman's earth, if free men make it, will 
                            ...
                            <p>What was most significant about the lunar voyage was not that man set foot on 
                                the Moon but that they set eye on the earth.</p>
                            ...
                            the thrill of just beginning.</p>
                            <p>There can be no thought of finishing for ‘aiming for the stars.’ Both figuratively and literally, 
                            ...
                            <blockquote className="blockquote">The dreams of yesterday are the hopes of today and the reality of tomorrow. Science has 
                            not yet mastered prophecy. We predict too much for the next year and yet far too little for the next ten.</blockquote>
                            ...
                            the most beautiful you can imagine. That beautiful, warm, living object looked so fragile, so delicate, that if you 
                            touched it with a finger it would crumble and fall apart. Seeing this has to change a man.</p>
                            <a href=""><img src={Astronaut} alt="astronaut" /></a>
                            <span className="text-muted">To go places and do things that have never been done before – that’s what living is all about.</span>
                            ...
                            to seek out new life and new civilizations, to boldly go where no man has gone before.</p>
                            <p>As I stand out here in the wonders of the unknown at Hadley, I sort of realize there’s a fundamental truth to our nature, 
                            Man must explore, and this is exploration at its greatest.</p>
